...
class Mysql_scrapy_pipeline(object):
    ...
    def _conditional_insert(self,tx,item): 
        sql = 'insert into post_nf_eng (id, url, site_id, data_type, title, content, post_time, scratch_time, poster_name, poster_id, poster_url, topic_id) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) ON DUPLICATE KEY UPDATE content=%s, post_time=%s'
