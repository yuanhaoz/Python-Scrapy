...
class huayanSpider(scrapy.Spider):
    name = "huayan"
    ...
    def start_requests(self):
        for index, key_word in enumerate(settings.KEY_WORDS): # enumerate返回'元素下标'和'元素内容'
            ...
            url = 'http://lp.search.gov.hk/search?query=' + kw_quote + '&ui_lang=zh-cn&tpl_id=govtlab&page=1&p_size=10&output=xml_no_dtd&ui_charset=utf-8&gp0=govtlab_home&gp1=govtlab_home&doc_type=all&sort=&web=this&txtonly=0&site=govtlab_home&last_mod=%23-1'
