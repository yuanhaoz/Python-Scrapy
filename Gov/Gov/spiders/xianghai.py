...
class xianghaiSpider(scrapy.Spider):
    name = "xianghai"
    ...
    def start_requests(self):
        for index, key_word in enumerate(settings.KEY_WORDS): # enumerate返回'元素下标'和'元素内容'
            ...
            # url = 'http://lp.search.gov.hk/search.html?query=' + kw_quote + '&ui_lang=zh-cn&tpl_id=edb_r2&page=1&p_size=10&output=xml_no_dtd&ui_charset=utf-8&gp0=edb_r2_home&gp1=edb_r2_home&doc_type=all&sort=&web=this&txtonly=0&site=edb_r2_home&last_mod=%23-1'
            url = 'http://lp.search.gov.hk/search?query=' + kw_quote + '&ui_lang=zh-cn&tpl_id=customs_r2&page=1&p_size=10&output=xml_no_dtd&ui_charset=utf-8&gp0=customs_r2_home&gp1=customs_r2_home&doc_type=all&sort=&web=this&txtonly=0&site=customs_r2_home&last_mod=%23-1'
