...
class xiangjinSpider(scrapy.Spider):
    name = "xiangjin"
    ...
    def start_requests(self):
        for index, key_word in enumerate(settings.KEY_WORDS): # enumerate返回'元素下标'和'元素内容'
            ...
            # url = 'http://lp.search.gov.hk/search.html?query=' + kw_quote + '&ui_lang=zh-cn&tpl_id=stdsearch&page=1&p_size=10&output=xml_no_dtd&ui_charset=utf-8&a_submit=false&gp0=dh_home&gp1=dh_home&doc_type=all&web=this&txtonly=0&site=dh_home&last_mod=%23-1&tab=&tab_depts=&sort=date'
